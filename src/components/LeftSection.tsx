...
const LeftSection = () => {
    ...
    const allChats = [
        {
            id: 1,
            chatName: 'What is new in Technology ?'
        },
        {
            id: 2,
            chatName: 'Birthday gift card ideas'
        },
        {
            id: 3,
            chatName: 'Goodmorning messages'
        },
        {
            id: 4,
            chatName: 'Learn coding with chat-gpt'
        },
        {
            id: 5,
            chatName: 'Terminologies in Web Development'
        }
    ]
    return (
        <div className={styles.leftSection}>
            ...
            <div className={styles.newChat}>
                <div>
                    ...
                    <p className={styles.text1}>Chat-gpt Clone by Tushar</p>
                </div>
